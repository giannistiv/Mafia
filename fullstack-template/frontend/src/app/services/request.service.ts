...
export class RequestService {
  ...
  public getAliveData(){
    return new Promise((resolve , reject) => {
      this.http.post(this.url + this.getAliveDataEndpoint).subscribe((data) => {
        resolve(data);
      });
    })
  }
  ...
  public getLastDead(){
    return new Promise((resolve , reject) => {
      this.http.post(this.url + this.getLastDeadEndpoint).subscribe((data) => {
        resolve(data);
      });
    })
  }
  ...
  public getDeadData(){
    return new Promise((resolve , reject) => {
      this.http.post(this.url + this.getDeadDataEndpoint).subscribe((data) => {
        resolve(data);
      });
    })
  }
  ...
  public addRound(){
    return new Promise((resolve , reject) => {
      this.http.post(this.url + this.addRoundEndpoint).subscribe((data) => {
        resolve(data);
      });
    })
  }
  ...
  public getRound(){
    return new Promise((resolve , reject) => {
      this.http.post(this.url + this.getRoundEndpoint).subscribe((data) => {
        resolve(data);
      });
    })
  }
